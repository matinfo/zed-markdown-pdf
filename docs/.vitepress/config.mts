...
export default defineConfig({
  ...
  description: 'Export Markdown to PDF with structured headers, footers, and custom styling',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Examples', link: '/examples/basic' },
      {
        text: 'Links',
        items: [
          { text: 'GitHub', link: 'https://github.com/matinfo/zed-markdown-pdf' },
      ...
      '/reference/': [
        {
          ...
          items: [
            ...
            { text: 'Header/Footer Schema', link: '/reference/header-footer-schema' },
    ...
    editLink: {
      pattern: 'https://github.com/matinfo/zed-markdown-pdf/edit/main/docs/:path',
